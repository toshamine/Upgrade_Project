 ...
 */
final class Version20211111182855 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE certification (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, image_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, company VARCHAR(255) DEFAULT NULL, difficulty VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, INDEX IDX_6C3C6D7512469DE2 (category_id), UNIQUE INDEX UNIQ_6C3C6D753DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE white_test (id INT AUTO_INCREMENT NOT NULL, certification_id INT NOT NULL, date DATE DEFAULT NULL, limit_time TIME DEFAULT NULL, time TIME DEFAULT NULL, INDEX IDX_DC66FD60CB47068A (certification_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
